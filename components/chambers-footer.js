          ...
          <div class="footer-card-inner">
              <div class="footer-main-grid">
                  ...
                  <div class="footer-chambers-col">
                      ...
                      <!-- Jurisdiction Chips -->
                      <div class="footer-jurisdictions-row">
                          <span class="footer-court-chip"><i class="fa-solid fa-landmark"></i> Allahabad High Court</span>
                          <span class="footer-court-chip"><i class="fa-solid fa-landmark"></i> Lucknow Bench</span>
                          <span class="footer-court-chip"><i class="fa-solid fa-gavel"></i> District Courts</span>
                          <span class="footer-court-chip"><i class="fa-solid fa-file-invoice"></i> Revenue Boards</span>
                      </div>
                  </div>
